...
public class Verify_Pinterest_landerProperties_Marketing_Platform_TestScript extends TestBase
{
	@Test
	public void Verify_Pinterest_landerProperties_Marketing_Platform_TestScript () throws Exception
	{
		PinterestPage pinterest=new PinterestPage(getDriver());
		
		pinterest.Verify_LanderProperties_EcommercePlatform();
		pinterest.MarketingPlatform();
