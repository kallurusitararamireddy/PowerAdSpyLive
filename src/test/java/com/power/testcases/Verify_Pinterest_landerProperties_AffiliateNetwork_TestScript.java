...
public class Verify_Pinterest_landerProperties_AffiliateNetwork_TestScript extends TestBase
{
	@Test
	public void Verify_Pinterest_landerProperties_AffiliateNetwork_TestScript () throws Exception
	{
		PinterestPage pinterest=new PinterestPage(getDriver());
		pinterest.Verify_LanderProperties_EcommercePlatform();
		
		pinterest.AffiliateNetwork();
